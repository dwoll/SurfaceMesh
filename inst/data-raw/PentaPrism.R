...
meshPentaPrism <- function(raw=TRUE, triangulate=TRUE) {
    ...
    if(raw) {
        ...
        makeMesh(lvf, triangulate=triangulate)
    }
}

# dataPentaPrism <- meshPentaPrism(raw=FALSE, triangulate=TRUE)
# wire3d(toRGL(dataPentaPrism))