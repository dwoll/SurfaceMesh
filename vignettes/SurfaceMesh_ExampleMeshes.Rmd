...
The geometric meshes included in package `SurfaceMesh` were originally part of R package [`SurfaceReconstruction`](https://github.com/stla/SurfaceReconstruction/), developed and copyright by [Stéphane Laurent](https://laustep.github.io/stlahblog/). Please see the following directory for the `.R` scripts for how to generate them.
