...
shade3d(heart1_rgl, col="gray")
```

```{r}
heart2_rgl <- toRGL(dataHeart2)
shade3d(heart2_rgl, col="gray")
```
...
```{r}
view3d(30, 30, zoom=0.8)
shade3d(dataSeptuaginta, col="gray")
```
...
view3d(30, 30, zoom=0.8)
shade3d(truncIcosahedron_rgl, col="gray")
```
...
```{r}
view3d(0, 0, zoom=0.8)
shade3d(dataTubularKnot, col="gray")
```
