...
Whole heart delineated by two observers in the same set of CT image slices. Class `CGALmesh`. To show using package `rgl`, first convert to class `mesh3d`.
...
```{r}
f_mesh <- system.file("extdata", "dataCornerHole.ply", package="SurfaceMesh")
...
TODO mesh with self-intersections.
